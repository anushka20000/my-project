...
const saveApplicant = async (req: Request, res: Response) =>{
    try{
...
const listApplicant = async (req: Request, res: Response) => {
    try{
    ...
    const editApplicant = async (req: Request, res: Response) => {
...
//  */
      ...
      const destroyApplicant = async (req: Request, res: Response) => {
        const id: any= req.params.id;
        
        try{
          const deletes: Applicant | null = await Applicant.findByPk(id);
      ...
      export {saveApplicant, listApplicant, editApplicant, updateApplicant, destroyApplicant}